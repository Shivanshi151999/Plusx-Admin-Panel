...
const ChargerBookingDetails = () => {
    ...
    return (
        <div className={styles.appSignupSection}>
            <BookingDetailsHeader content={content} titles={headerTitles} sectionContent = {sectionContent}
                type = 'portableChargerBooking' 
            />
            <div className={styles.bookingDetailsSection}>
                <BookingLeftDetails titles = {sectionTitles} content = {sectionContent} type = 'portableChargerBooking' />
